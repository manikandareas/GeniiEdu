...
import { createLearningMaterial } from '@/app/_actions/materials-actions';
...
const CreateLMForm = () => {
    ...
    const createLMForm = useForm<z.infer<typeof addMaterialValidation>>({
        resolver: zodResolver(addMaterialValidation),
        defaultValues: {
            content: '',
            files: [],
            title: '',
    ...
    const onCreateModuleClicked = async (
        values: z.infer<typeof addMaterialValidation>,
    ) => {
