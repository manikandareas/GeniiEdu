'use client';
import { createAssignment } from '@/app/_actions/assignments-actions';
...
import { TimePeriodSelect } from '@/app/_components/ui/time-period-select';
import { TimePickerInput } from '@/app/_components/ui/time-picker-input';
import { Period } from '@/app/_components/ui/time-picker-utils';
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
...
const CreateAssignmentForm: React.FC<CreateAssignmentFormProps> = (props) => {
    const createAssignmentForm = useForm<
        z.infer<typeof addAssignmentValidation>
    >({
        resolver: zodResolver(addAssignmentValidation),
        defaultValues: {
            title: '',
            description: '',
            dueDate: new Date(),
    ...
    const onCreateAssignmentClicked = async (
        values: z.infer<typeof addAssignmentValidation>,
    ) => {
