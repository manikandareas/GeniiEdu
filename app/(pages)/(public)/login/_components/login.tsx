...
import { userLoginValidation } from '@/app/_validations/auth-validation';
...
const Login = () => {
    const LoginForm = useForm<z.infer<typeof userLoginValidation>>({
    ...
    const onSubmitClicked = async (
        values: z.infer<typeof userLoginValidation>,
    ) => {
