...
import { removeFile } from '@/actions/storage.actions';
...
const CreateClassForm = () => {
    ...
    >({
        resolver: zodResolver(ClassesModel.createClassSchema),
        defaultValues: {
            accessType: 'private',
            classCode: '',
            className: '',
    ...
    const onCreateClassClicked = async (
        values: z.infer<typeof ClassesModel.createClassSchema>,
    ) => {
    ...
    const onClearThumbnailClicked = async () => {
        ...
        const res = await removeFile(
            createClassForm.getValues('thumbnailKey') as string,
        );
